              ...
              hover:shadow-md"
                        ...
                        >
                            <svg
                                ...
                                className={`h-5 w-5 fill-current text-white ${theme === 'light'
                                    ? ''
                                    : 'hidden'
                                    }`}
                                viewBox="0 0 20 20"
                            ...
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className={`h-5 w-5 fill-current text-white ${theme === 'dark'
                                    ? ''
                                    : 'hidden'
                                    }`}
                                viewBox="0 0 24 24"
